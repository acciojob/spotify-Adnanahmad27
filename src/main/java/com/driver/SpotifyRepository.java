...
public class SpotifyRepository {
    ...
    private Optional<Artist> findArtist(String artistName){
        for(Artist artist : artists){
            if(artist.getName().equals(artistName)) return Optional.of(artist);
        }
        return Optional.empty();
    }
    ...
    public Optional<Album> findAlbum(String albumName){
        for(Album album : albums){
            if(album.getTitle().equals(albumName)) return Optional.of(album);
        }
        return Optional.empty();
    }
    ...
    private Optional<Playlist> findPlaylistsByTitle(String playlistTitle){
    ...
    public Playlist findPlaylist(String mobile, String playlistTitle) throws Exception {
        ...
        User user = optionalUser.get();
        Optional<Playlist> optionalPlaylist = findPlaylistsByTitle(playlistTitle);
        if(optionalPlaylist.isEmpty()) throw new Exception("Playlist does not exist");
    ...
    public Song likeSong(String mobile, String songTitle) throws Exception {
        ...
        if(optionalSong.isEmpty()) throw new Exception("Song does not exist");
    ...
    public String mostPopularArtist() {
        ...
        for(Artist artist : artistLikeMap.keySet()){
            int size = songLikeMap.get(artist).size();
            if(size > like){
                like = size;
